...
class TicketsRepository implements TicketRepositoryInterface
{
    ...
    public function update_ticket($request, $id)
    {
        ...
        $ticket_updates= ticket::where('id', $id)->update(array_merge($request->except('_token', 'log_entry', 'file_input'), ['previous_user_id' => $ticket->user_action_id, 'previous_status_id' => $ticket->status_id, 'previous_group_id' => $ticket->group_id, 'user_action_id' => Auth::user()->id]));
