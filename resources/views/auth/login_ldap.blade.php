...
<html lang="en">
	...
	<head>
		...
		<link href="{{ asset('public/new_design/assets/css/pages/login/classic/login-4.css')}}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-secondary-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-4 login-signin-on d-flex flex-row-fluid" id="kt_login">
				<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('{{ asset('public/new_design/assets/media/bg/bg-3.jpg')}}');">
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						<!--begin::Login Header-->
						<div class="d-flex flex-center mb-15">
							<a href="#">
								<img src="{{ asset('public/logo.jpg')}}" class="max-h-75px" alt="" />
							</a>
						</div>
						<!--end::Login Header-->
						...
						<div class="login-signin">
							...
							<form class="form" id="kt_login_signin_form" method="POST" action="{{ route('login/ldap') }}">
                                @if($errors->any())
								...
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="User Name" name="user_name" autocomplete="off" />
								</div>
								<div class="form-group mb-5">
		...
		{{--  <script src="{{ asset('public/new_design/assets/js/pages/custom/login/login-general.js')}}"></script>  --}}
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>
