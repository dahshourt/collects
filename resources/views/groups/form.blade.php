                                    ...
                                    <div class="form-group row fv-plugins-icon-container">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <div class="input-group input-group-solid input-group-lg">
                                                ...
                                                <input type="email" class="form-control form-control-solid form-control-lg" name="group_email" value="" required>
                                            </div>
                                        <div class="fv-plugins-message-container"></div></div>
                                    </div>
                                    <!--begin::Group-->
                                    ...
                                    <div class="form-group row fv-plugins-icon-container">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <div class="input-group input-group-solid input-group-lg">
                                                ...
                                                <textarea class="form-control form-control-solid form-control-lg" name="description"  rows="3"></textarea>
