...
<div class="card card-custom">
    <div class="card-header flex-wrap py-5">
        ...
        <div class="card-toolbar">
            ...
            @if(Auth::user()->role == 1)
            <button type="button" class="btn btn-warning font-weight-bolder ml-2" onclick="showLogs('Group')">
        ...
        <table class="table table-separate table-head-custom table-checkable" id="example2">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td nowrap="nowrap">
                        <a href="{{route('groups.edit',$group)}}" class="btn btn-light-success font-weight-bold mr-2">edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
