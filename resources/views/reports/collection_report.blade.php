            ...
            <div class="col-md-12">
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        ...
                        @if(Auth::user()->role == 1)
                        <button type="button" class="btn btn-warning float-right ml-2" onclick="showLogs('Report','Collection Report')">
                    ...
                    <form name="add-blog-post-form" id="add-blog-post-form" method="get" action="{{url('report/entrp-report-result')}}">
                        <div class="card-body">
                            <div class="form-group col-md-6"><label>Ticket creation date</label><input type="date" class="form-control" name="created_at" /></div>
                            ...
                            <div class="form-group col-md-6"><label>Amount</label><input type="number" class="form-control" placeholder="Enter Amount" name="transaction_amount" /></div>
                            ...
                            <div class="form-group col-md-6"><label>Customer Name <span class="text-danger">*</span></label><input type="text" class="form-control" placeholder="Enter Customer Name" name="customer_name" /></div>
                            <div class="form-group col-md-6">
