                    ...
                    <form name="add-blog-post-form" id="add-blog-post-form" method="get" action="{{url('report/entrp-report-result')}}">
                        <div class="card-body">
                            ...
                            <div class="form-group col-md-6">
                                <label>Ticket Creation Start Date
                                </label>
                                <input type="datetime-local" class="form-control" name="created_at" />
                            </div>
                            
                            <div class="form-group col-md-6">
                                <label>Ticket Creation End date
                                </label>
                                <input type="datetime-local" class="form-control"  name="end_created_at" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control amount-formate" placeholder="Enter Amount" name="transaction_amount" />
                            </div>
                            <div class="form-group col-md-6">
                                <label>Ticket Number
                                </label>
                                <input type="number" class="form-control" placeholder="Enter Ticket Number" name="ticket_num" />
                            </div>
                            <div class="form-group col-md-6">
                             ...
                             <div class="form-group col-md-6">
                                <label for="exampleSelect1">creator Name 
                                </label>
