...
<div class="card card-custom">
    <div class="card-header flex-wrap py-5">
        ...
        <div class="card-toolbar">
            ...
            @if(Auth::user()->role == 1)
            <button type="button" class="btn btn-warning font-weight-bolder ml-2" onclick="showLogs('User')">
    ...
    <div class="form-group m-form__group row">
        <div class="col-7">
            @php $append = (request()->search)? "?search=".request()->search : ""; @endphp
        </div>
        <div class="col-3">
        ...
        <table class="table table-separate table-head-custom table-checkable" id="example2">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td nowrap="nowrap">
                        <a href="{{route('users.edit',$user)}}" class="btn btn-light-success font-weight-bold mr-2">edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
    ...
    <script>
        ...
        $(function() {
            $("#example1").DataTable({
                ...
                "ordering": false, "buttons": ["copy","csv","excel","pdf","print","colvis"]
            }).buttons().container().appendTo('#example1_wrapper .col-md-6:eq(0)');
            $('#example2').DataTable({
                "paging": false, "lengthChange": false, "searching": false,
                "ordering": true, "info": false, "autoWidth": false, "responsive": false,
            });
        });
        $("#confirm_search").click(function(){
            var $search = $("#search").val();
            window.location.href = '{{ url("/users/index") }}?search='+$search;
        });
